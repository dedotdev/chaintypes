...
export type SystemParachainsCommonPayVersionedLocatableAccount =
  | {
      type: 'V3';
      value: { location: StagingXcmV3MultilocationMultiLocation; accountId: StagingXcmV3MultilocationMultiLocation };
    }
