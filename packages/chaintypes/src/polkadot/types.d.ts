...
export type PalletProxyCall =
  ...
  | {
      name: 'AddProxy';
      params: { delegate: MultiAddress; proxyType: PolkadotRuntimeConstantsProxyProxyType; delay: number };
    }
  /**
   ...
   **/
  | { name: 'CreatePure'; params: { proxyType: PolkadotRuntimeConstantsProxyProxyType; delay: number; index: number } }
  /**
...
export type PalletProxyCallLike =
  ...
  | {
      name: 'AddProxy';
      params: { delegate: MultiAddressLike; proxyType: PolkadotRuntimeConstantsProxyProxyType; delay: number };
    }
  /**
   * Unregister a proxy account for the sender.
   *
