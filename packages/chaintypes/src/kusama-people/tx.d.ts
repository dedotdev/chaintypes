...
import type {
  ...
  PeopleKusamaRuntimePeopleIdentityInfo,
  PalletIdentityJudgement,
} from './types.js';

export type ChainSubmittableExtrinsic<
  T extends IRuntimeTxCall = PeopleKusamaRuntimeRuntimeCallLike,
...
export type TxCall<ChainKnownTypes extends GenericChainKnownTypes = GenericChainKnownTypes> = (
  ...args: any[]
) => ChainSubmittableExtrinsic<PeopleKusamaRuntimeRuntimeCallLike, ChainKnownTypes>;
...
> extends GenericChainTx<TxCall<ChainKnownTypes>> {
  ...
  session: {
    ...
    setKeys: GenericTxCall<
      (
        keys: PeopleKusamaRuntimeSessionKeys,
        proof: BytesLike,
      ) => ChainSubmittableExtrinsic<
        {
          pallet: 'Session';
          palletCall: {
            name: 'SetKeys';
            params: { keys: PeopleKusamaRuntimeSessionKeys; proof: BytesLike };
          };
        },
        ChainKnownTypes
      >
  ...
  utility: {
     ...
     * event is deposited.
     *
     * @param {Array<PeopleKusamaRuntimeRuntimeCallLike>} calls
     **/
    batch: GenericTxCall<
      (calls: Array<PeopleKusamaRuntimeRuntimeCallLike>) => ChainSubmittableExtrinsic<
        {
          pallet: 'Utility';
          palletCall: {
            name: 'Batch';
            params: { calls: Array<PeopleKusamaRuntimeRuntimeCallLike> };
          };
        },
        ChainKnownTypes
      >
    ...
    asDerivative: GenericTxCall<
      (
      ...
      ) => ChainSubmittableExtrinsic<
        {
          ...
          palletCall: {
            name: 'AsDerivative';
            params: { index: number; call: PeopleKusamaRuntimeRuntimeCallLike };
          };
        },
        ChainKnownTypes
      >
    ...
    withWeight: GenericTxCall<
      (
      ...
      ) => ChainSubmittableExtrinsic<
        {
          ...
          palletCall: {
            name: 'WithWeight';
            params: { call: PeopleKusamaRuntimeRuntimeCallLike; weight: SpWeightsWeightV2Weight };
          };
        },
        ChainKnownTypes
      >
  ...
  proxy: {
     ...
     * @param {PeopleKusamaRuntimeProxyType | undefined} forceProxyType
     * @param {PeopleKusamaRuntimeRuntimeCallLike} call
     **/
    proxy: GenericTxCall<
      (
    ...
    createPure: GenericTxCall<
      (
      ...
      ) => ChainSubmittableExtrinsic<
        {
          ...
          palletCall: {
            name: 'CreatePure';
            params: { proxyType: PeopleKusamaRuntimeProxyType; delay: number; index: number };
          };
        },
        ChainKnownTypes
      >
  ...
  identity: {
     ...
     *
     * @param {PeopleKusamaRuntimePeopleIdentityInfo} info
     **/
    setIdentity: GenericTxCall<
      (info: PeopleKusamaRuntimePeopleIdentityInfo) => ChainSubmittableExtrinsic<
        {
          pallet: 'Identity';
          palletCall: {
            name: 'SetIdentity';
            params: { info: PeopleKusamaRuntimePeopleIdentityInfo };
          };
        },
        ChainKnownTypes
      >
