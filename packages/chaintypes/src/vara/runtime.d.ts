...
export interface RuntimeApis<Rv extends RpcVersion>
  ...
  gearStakingRewardsApi: {
     ...
     **/
    inflationInfo: GenericRuntimeApiMethod<
      Rv,
      () => Promise<PalletGearStakingRewardsInflationInfo>
    >;
  ...
  gearBuiltinApi: {
     ...
     **/
    queryActorId: GenericRuntimeApiMethod<
      Rv,
      (builtinId: bigint) => Promise<H256>
    >;
  ...
  gearEthBridgeApi: {
     ...
     * @param {H256} hash
     **/
    merkleProof: GenericRuntimeApiMethod<
      Rv,
      (hash: H256) => Promise<PalletGearEthBridgeInternalProof | undefined>
    >;
  ...
  gearApi: {
     ...
     **/
    gearRunExtrinsic: GenericRuntimeApiMethod<
      Rv,
      (maxGas?: bigint | undefined) => Promise<UncheckedExtrinsic>
    >;
