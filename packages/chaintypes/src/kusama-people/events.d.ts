...
import type { DispatchError, H256, AccountId32, FixedBytes, Bytes, Result } from 'dedot/codecs';
import type {
...
export interface ChainEvents extends GenericChainEvents {
  ...
  proxy: {
    ...
    PureKilled: GenericPalletEvent<
      'Proxy',
      'PureKilled',
      { pure: AccountId32; spawner: AccountId32; proxyType: PeopleKusamaRuntimeProxyType; disambiguationIndex: number }
    >;
