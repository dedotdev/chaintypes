...
export type FrameSystemEventRecord = { phase: Phase; event: PeopleKusamaRuntimeRuntimeEvent; topics: Array<H256> };
...
export type PeopleKusamaRuntimeRuntimeHoldReason = null;
...
export type PalletUtilityCall =
   ...
   * event is deposited.
   **/
  | { name: 'Batch'; params: { calls: Array<PeopleKusamaRuntimeRuntimeCall> } }
  /**
   ...
   **/
  | { name: 'AsDerivative'; params: { index: number; call: PeopleKusamaRuntimeRuntimeCall } }
  /**
   ...
   * - O(C) where C is the number of calls to be batched.
   **/
  | { name: 'BatchAll'; params: { calls: Array<PeopleKusamaRuntimeRuntimeCall> } }
  /**
   ...
   * - O(1).
   **/
  | { name: 'DispatchAs'; params: { asOrigin: PeopleKusamaRuntimeOriginCaller; call: PeopleKusamaRuntimeRuntimeCall } }
  /**
   * Send a batch of dispatch calls.
   ...
   * - O(C) where C is the number of calls to be batched.
   **/
  | { name: 'ForceBatch'; params: { calls: Array<PeopleKusamaRuntimeRuntimeCall> } }
  /**
...
export type PalletUtilityCallLike =
   ...
   * event is deposited.
   **/
  | { name: 'Batch'; params: { calls: Array<PeopleKusamaRuntimeRuntimeCallLike> } }
  /**
   * Send a call through an indexed pseudonym of the sender.
   *
   * Filter from origin are passed along. The call will be dispatched with an origin which
   ...
   * The dispatch origin for this call must be _Signed_.
   **/
  | { name: 'AsDerivative'; params: { index: number; call: PeopleKusamaRuntimeRuntimeCallLike } }
  /**
   * Send a batch of dispatch calls and atomically execute them.
   * The whole transaction will rollback and fail if any of the calls failed.
   *
   ...
   * - O(C) where C is the number of calls to be batched.
   **/
  | { name: 'BatchAll'; params: { calls: Array<PeopleKusamaRuntimeRuntimeCallLike> } }
  /**
   * Dispatches a function call with a provided origin.
   *
   * The dispatch origin for this call must be _Root_.
   ...
   * - O(C) where C is the number of calls to be batched.
   **/
  | { name: 'ForceBatch'; params: { calls: Array<PeopleKusamaRuntimeRuntimeCallLike> } }
  /**
   * Dispatch a function call with a specified weight.
   *
   * This function does not check the weight of the call, and instead allows the
...
export type PalletMultisigCall =
  ...
  | {
      ...
      params: { otherSignatories: Array<AccountId32>; call: PeopleKusamaRuntimeRuntimeCall };
    }
  /**
...
export type PalletMultisigCallLike =
  ...
  | {
      name: 'AsMultiThreshold1';
      params: { otherSignatories: Array<AccountId32Like>; call: PeopleKusamaRuntimeRuntimeCallLike };
    }
  /**
   * Register approval for a dispatch to be made from a deterministic composite account if
   * approved by a total of `threshold - 1` of `other_signatories`.
...
export type PalletProxyCall =
   ...
   * zero.
   **/
  | { name: 'AddProxy'; params: { delegate: MultiAddress; proxyType: PeopleKusamaRuntimeProxyType; delay: number } }
  /**
   ...
   **/
  | { name: 'RemoveProxy'; params: { delegate: MultiAddress; proxyType: PeopleKusamaRuntimeProxyType; delay: number } }
  /**
   ...
   **/
  | { name: 'CreatePure'; params: { proxyType: PeopleKusamaRuntimeProxyType; delay: number; index: number } }
  /**
...
export type PalletProxyCallLike =
   ...
   * zero.
   **/
  | { name: 'AddProxy'; params: { delegate: MultiAddressLike; proxyType: PeopleKusamaRuntimeProxyType; delay: number } }
  /**
   * Unregister a proxy account for the sender.
   *
   * The dispatch origin for this call must be _Signed_.
  ...
  | {
      name: 'RemoveProxy';
      params: { delegate: MultiAddressLike; proxyType: PeopleKusamaRuntimeProxyType; delay: number };
    }
  /**
   * Unregister all proxy accounts for the sender.
   *
...
export type PalletIdentityCall =
   ...
   **/
  | { name: 'SetIdentity'; params: { info: PeopleKusamaRuntimePeopleIdentityInfo } }
  /**
...
export type PalletIdentityRegistration = {
  ...
  deposit: bigint;
  info: PeopleKusamaRuntimePeopleIdentityInfo;
};
