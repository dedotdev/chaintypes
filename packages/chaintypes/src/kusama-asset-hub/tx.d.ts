...
export type ChainSubmittableExtrinsic<
  T extends IRuntimeTxCall = AssetHubKusamaRuntimeRuntimeCallLike,
...
export type TxCall<ChainKnownTypes extends GenericChainKnownTypes = GenericChainKnownTypes> = (
  ...args: any[]
) => ChainSubmittableExtrinsic<AssetHubKusamaRuntimeRuntimeCallLike, ChainKnownTypes>;
...
> extends GenericChainTx<TxCall<ChainKnownTypes>> {
  ...
  system: {
    ...
    /**
     *
     * @param {AssetHubKusamaRuntimeRuntimeTask} task
     **/
    doTask: GenericTxCall<
      (task: AssetHubKusamaRuntimeRuntimeTask) => ChainSubmittableExtrinsic<
        {
          pallet: 'System';
          palletCall: {
            name: 'DoTask';
            params: { task: AssetHubKusamaRuntimeRuntimeTask };
          };
        },
        ChainKnownTypes
      >
  ...
  parameters: {
     ...
     *
     * @param {AssetHubKusamaRuntimeRuntimeParameters} keyValue
     **/
    setParameter: GenericTxCall<
      (keyValue: AssetHubKusamaRuntimeRuntimeParameters) => ChainSubmittableExtrinsic<
        {
          pallet: 'Parameters';
          palletCall: {
            name: 'SetParameter';
            params: { keyValue: AssetHubKusamaRuntimeRuntimeParameters };
          };
        },
        ChainKnownTypes
      >
  ...
  multiBlockElectionSigned: {
     ...
     *
     * @param {number} page
     * @param {AssetHubKusamaRuntimeStakingNposCompactSolution24 | undefined} maybeSolution
     **/
    submitPage: GenericTxCall<
      (
        page: number,
        maybeSolution: AssetHubKusamaRuntimeStakingNposCompactSolution24 | undefined,
      ) => ChainSubmittableExtrinsic<
        {
          pallet: 'MultiBlockElectionSigned';
          palletCall: {
  ...
  referenda: {
     ...
     * Emits `Submitted`.
     *
     * @param {AssetHubKusamaRuntimeOriginCaller} proposalOrigin
