...
export interface ChainEvents extends GenericChainEvents {
  ...
  dmpQueue: {
     ...
     **/
    StartedExport: GenericPalletEvent<'DmpQueue', 'StartedExport', null>;

    /**
     * The export of a page completed.
     **/
    Exported: GenericPalletEvent<'DmpQueue', 'Exported', { page: number }>;
     ...
     **/
    ExportFailed: GenericPalletEvent<'DmpQueue', 'ExportFailed', { page: number }>;

    /**
     * The export of pages completed.
     **/
    CompletedExport: GenericPalletEvent<'DmpQueue', 'CompletedExport', null>;

    /**
     * The export of overweight messages started.
     **/
    StartedOverweightExport: GenericPalletEvent<'DmpQueue', 'StartedOverweightExport', null>;

    /**
     * The export of an overweight message completed.
     **/
    ExportedOverweight: GenericPalletEvent<'DmpQueue', 'ExportedOverweight', { index: bigint }>;
     ...
     * This should never be emitted.
     **/
    ExportOverweightFailed: GenericPalletEvent<'DmpQueue', 'ExportOverweightFailed', { index: bigint }>;

    /**
     * The export of overweight messages completed.
     **/
    CompletedOverweightExport: GenericPalletEvent<'DmpQueue', 'CompletedOverweightExport', null>;

    /**
     * The cleanup of remaining pallet storage started.
     **/
    StartedCleanup: GenericPalletEvent<'DmpQueue', 'StartedCleanup', null>;

    /**
     * Some debris was cleaned up.
     **/
    CleanedSome: GenericPalletEvent<'DmpQueue', 'CleanedSome', { keysRemoved: number }>;

    /**
     * The cleanup of remaining pallet storage completed.
     **/
    Completed: GenericPalletEvent<'DmpQueue', 'Completed', { error: boolean }>;
