...
export type FrameSystemEventRecord = { phase: Phase; event: PeoplePaseoRuntimeRuntimeEvent; topics: Array<H256> };
...
export type PeoplePaseoRuntimeRuntimeHoldReason = null;
...
export type PalletUtilityCall =
   ...
   * event is deposited.
   **/
  | { name: 'Batch'; params: { calls: Array<PeoplePaseoRuntimeRuntimeCall> } }
  /**
   ...
   **/
  | { name: 'AsDerivative'; params: { index: number; call: PeoplePaseoRuntimeRuntimeCall } }
  /**
   ...
   * - O(C) where C is the number of calls to be batched.
   **/
  | { name: 'BatchAll'; params: { calls: Array<PeoplePaseoRuntimeRuntimeCall> } }
  /**
   ...
   * - O(1).
   **/
  | { name: 'DispatchAs'; params: { asOrigin: PeoplePaseoRuntimeOriginCaller; call: PeoplePaseoRuntimeRuntimeCall } }
  /**
   * Send a batch of dispatch calls.
   ...
   * - O(C) where C is the number of calls to be batched.
   **/
  | { name: 'ForceBatch'; params: { calls: Array<PeoplePaseoRuntimeRuntimeCall> } }
  /**
...
export type PalletUtilityCallLike =
   ...
   * event is deposited.
   **/
  | { name: 'Batch'; params: { calls: Array<PeoplePaseoRuntimeRuntimeCallLike> } }
  /**
   * Send a call through an indexed pseudonym of the sender.
   *
   * Filter from origin are passed along. The call will be dispatched with an origin which
   ...
   * The dispatch origin for this call must be _Signed_.
   **/
  | { name: 'AsDerivative'; params: { index: number; call: PeoplePaseoRuntimeRuntimeCallLike } }
  /**
   * Send a batch of dispatch calls and atomically execute them.
   * The whole transaction will rollback and fail if any of the calls failed.
   *
   ...
   * - O(C) where C is the number of calls to be batched.
   **/
  | { name: 'BatchAll'; params: { calls: Array<PeoplePaseoRuntimeRuntimeCallLike> } }
  /**
   * Dispatches a function call with a provided origin.
   *
   * The dispatch origin for this call must be _Root_.
   ...
   * - O(C) where C is the number of calls to be batched.
   **/
  | { name: 'ForceBatch'; params: { calls: Array<PeoplePaseoRuntimeRuntimeCallLike> } }
  /**
   * Dispatch a function call with a specified weight.
   *
   * This function does not check the weight of the call, and instead allows the
...
export type PalletMultisigCall =
   ...
   **/
  | { name: 'AsMultiThreshold1'; params: { otherSignatories: Array<AccountId32>; call: PeoplePaseoRuntimeRuntimeCall } }
  /**
...
export type PalletProxyCall =
   ...
   * zero.
   **/
  | { name: 'AddProxy'; params: { delegate: MultiAddress; proxyType: PeoplePaseoRuntimeProxyType; delay: number } }
  /**
   ...
   **/
  | { name: 'RemoveProxy'; params: { delegate: MultiAddress; proxyType: PeoplePaseoRuntimeProxyType; delay: number } }
  /**
   ...
   **/
  | { name: 'CreatePure'; params: { proxyType: PeoplePaseoRuntimeProxyType; delay: number; index: number } }
  /**
...
export type PalletProxyCallLike =
   ...
   * zero.
   **/
  | { name: 'AddProxy'; params: { delegate: MultiAddressLike; proxyType: PeoplePaseoRuntimeProxyType; delay: number } }
  /**
   * Unregister a proxy account for the sender.
   *
   * The dispatch origin for this call must be _Signed_.
...
export type PalletIdentityCall =
   ...
   **/
  | { name: 'SetIdentity'; params: { info: PeoplePaseoRuntimePeopleIdentityInfo } }
  /**
...
export type PalletIdentityRegistration = {
  ...
  deposit: bigint;
  info: PeoplePaseoRuntimePeopleIdentityInfo;
};
