...
export type ChainSubmittableExtrinsic<
  T extends IRuntimeTxCall = PolkadotRuntimeRuntimeCallLike,
...
export type TxCall<ChainKnownTypes extends GenericChainKnownTypes = GenericChainKnownTypes> = (
  ...args: any[]
) => ChainSubmittableExtrinsic<PolkadotRuntimeRuntimeCallLike, ChainKnownTypes>;
...
> extends GenericChainTx<TxCall<ChainKnownTypes>> {
  ...
  proxy: {
     ...
     * @param {PolkadotRuntimeConstantsProxyProxyType | undefined} forceProxyType
     * @param {PolkadotRuntimeRuntimeCallLike} call
     **/
    proxy: GenericTxCall<
      (
    ...
    createPure: GenericTxCall<
      (
      ...
      ) => ChainSubmittableExtrinsic<
        {
          ...
          palletCall: {
            name: 'CreatePure';
            params: { proxyType: PolkadotRuntimeConstantsProxyProxyType; delay: number; index: number };
          };
        },
        ChainKnownTypes
      >
