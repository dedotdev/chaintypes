...
export interface ChainEvents<Rv extends RpcVersion> extends GenericChainEvents<Rv> {
  ...
  system: {
     ...
     **/
    TaskStarted: GenericPalletEvent<Rv, 'System', 'TaskStarted', { task: AssetHubPaseoRuntimeRuntimeTask }>;

    /**
     * A [`Task`] has finished executing.
     **/
    TaskCompleted: GenericPalletEvent<Rv, 'System', 'TaskCompleted', { task: AssetHubPaseoRuntimeRuntimeTask }>;
