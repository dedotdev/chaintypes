...
export type PalletBalancesEvent =
   ...
   **/
  | { name: 'Held'; data: { reason: MoonbeamRuntimeRuntimeHoldReason; who: AccountId20; amount: bigint } }
  /**
   * Held balance was burned from an account.
   **/
  | { name: 'BurnedHeld'; data: { reason: MoonbeamRuntimeRuntimeHoldReason; who: AccountId20; amount: bigint } }
  /**
   * A transfer of `amount` on hold from `source` to `dest` was initiated.
   **/
  | {
      name: 'TransferOnHold';
      data: { reason: MoonbeamRuntimeRuntimeHoldReason; source: AccountId20; dest: AccountId20; amount: bigint };
    }
  /**
  ...
  | {
      ...
      data: { reason: MoonbeamRuntimeRuntimeHoldReason; source: AccountId20; dest: AccountId20; transferred: bigint };
    }
  /**
   * Some balance was released from hold.
   **/
  | { name: 'Released'; data: { reason: MoonbeamRuntimeRuntimeHoldReason; who: AccountId20; amount: bigint } }
  /**
...
export type PalletConvictionVotingEvent =
   ...
   **/
  | { name: 'Delegated'; data: [AccountId20, AccountId20, number] }
  /**
   * An \[account\] has cancelled a previous delegation operation.
   **/
  | { name: 'Undelegated'; data: [AccountId20, number] }
  /**
   * An account has voted
   **/
  | { name: 'Voted'; data: { who: AccountId20; vote: PalletConvictionVotingVoteAccountVote; pollIndex: number } }
  /**
   * A vote has been removed
   **/
  | { name: 'VoteRemoved'; data: { who: AccountId20; vote: PalletConvictionVotingVoteAccountVote; pollIndex: number } }
  /**
