...
export type PaseoRuntimeRuntimeEvent =
  ...
  | { pallet: 'ImOnline'; palletEvent: PaseoRuntimePalletImOnlinePalletEvent }
 ...
 * The `Event` enum of this pallet
 **/
export type PaseoRuntimePalletImOnlinePalletEvent =
  | { name: 'HeartbeatReceived'; data: { authorityId: PaseoRuntimePalletImOnlineSr25519AppSr25519Public } }
  | { name: 'AllGood' }
  | { name: 'SomeOffline'; data: { offline: Array<[AccountId32, SpStakingExposure]> } };

export type PaseoRuntimePalletImOnlineSr25519AppSr25519Public = SpCoreSr25519Public;
...
export type PalletBalancesIdAmount = { id: PaseoRuntimeRuntimeHoldReason; amount: bigint };
...
export type PalletBalancesIdAmountRuntimeFreezeReason = { id: PaseoRuntimeRuntimeFreezeReason; amount: bigint };
