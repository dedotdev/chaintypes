...
export type PalletUtilityCall =
   ...
   * or both.
   **/
  | { name: 'IfElse'; params: { main: AstarRuntimeRuntimeCall; fallback: AstarRuntimeRuntimeCall } }
  /**
   * Dispatches a function call with a provided origin.
   *
   ...
   * The dispatch origin for this call must be _Root_.
   **/
  | { name: 'DispatchAsFallible'; params: { asOrigin: AstarRuntimeOriginCaller; call: AstarRuntimeRuntimeCall } };
...
export type PalletUtilityCallLike =
   ...
   * or both.
   **/
  | { name: 'IfElse'; params: { main: AstarRuntimeRuntimeCallLike; fallback: AstarRuntimeRuntimeCallLike } }
  /**
   * Dispatches a function call with a provided origin.
   *
   * Almost the same as [`Pallet::dispatch_as`] but forwards any error of the inner call.
   ...
   * The dispatch origin for this call must be _Root_.
   **/
  | { name: 'DispatchAsFallible'; params: { asOrigin: AstarRuntimeOriginCaller; call: AstarRuntimeRuntimeCallLike } };
...
export type PalletProxyEvent =
  ...
  | {
      name: 'PureKilled';
      data: { pure: AccountId32; spawner: AccountId32; proxyType: AstarRuntimeProxyType; disambiguationIndex: number };
    }
  /**
