...
import type { RuntimeVersion, Bytes, AccountId32, Permill, Perbill, FixedU128, FixedBytes } from 'dedot/codecs';
import type {
  ...
  IndivPalletMembersSubscriberNotifierEndpoint,
...
export interface ChainConsts extends GenericChainConsts {
  ...
  /**
   * Pallet `MembersSubscriber`'s constants
   **/
  membersSubscriber: {
    /**
     ...
     **/
    ringRootsNotifier: IndivPalletMembersSubscriberNotifierEndpoint;
  ...
  /**
   * Pallet `AliasAccounts`'s constants
   **/
  aliasAccounts: {
    /**
     ...
     **/
    mappingRetention: bigint;

    /**
     * Ring exponent for People Lite.
     **/
    peopleLiteRingExponent: IndivSupportRealityRingExponent;

    /**
     * Ring exponent for People.
     **/
    peopleRingExponent: IndivSupportRealityRingExponent;
     ...
     **/
    maxStaleAliasBatch: number;
    peopleCollectionIdentifier: FixedBytes<32>;
    peopleLiteCollectionIdentifier: FixedBytes<32>;
  ...
  pgas: {
     ...
     **/
    maxClaimsPerPeriodPerLitePerson: number;

    /**
     * Maximum number of PGAS claim records that can be cleaned up in a single call.
     **/
    maxPgasClaimRecordCleanupPerCall: number;
  ...
  /**
   * Pallet `DotnsGateway`'s constants
   **/
  dotnsGateway: {
    /**
     ...
     **/
    maxContractCallWeight: SpWeightsWeightV2Weight;
