...
export interface ChainStorage<Rv extends RpcVersion>
  ...
  session: {
    ...
    queuedKeys: GenericStorageQuery<
      Rv,
      () => Array<[AccountId32, VaraRuntimeSessionKeys]>
    >;
    ...
    nextKeys: GenericStorageQuery<
      Rv,
      (arg: AccountId32Like) => VaraRuntimeSessionKeys | undefined,
      AccountId32
    >;
  ...
  staking: {
    ...
    ledger: GenericStorageQuery<
      Rv,
      (arg: AccountId32Like) => PalletStakingStakingLedger | undefined,
      AccountId32
    >;
    ...
    payee: GenericStorageQuery<
      Rv,
      (arg: AccountId32Like) => PalletStakingRewardDestination | undefined,
      AccountId32
    >;
    ...
    validators: GenericStorageQuery<
      Rv,
      (arg: AccountId32Like) => PalletStakingValidatorPrefs,
      AccountId32
    >;
    ...
    nominators: GenericStorageQuery<
      Rv,
      (arg: AccountId32Like) => PalletStakingNominations | undefined,
      AccountId32
    >;
    ...
    activeEra: GenericStorageQuery<
      Rv,
      () => PalletStakingActiveEraInfo | undefined
    >;
     ...
     * @param {Callback<number | undefined> =} callback
     **/
    erasStartSessionIndex: GenericStorageQuery<
      Rv,
    ...
    erasStakersPaged: GenericStorageQuery<
      ...
      (
        arg: [number, AccountId32Like, number],
      ) => SpStakingExposurePage | undefined,
    ...
    erasRewardPoints: GenericStorageQuery<
      Rv,
      (arg: number) => PalletStakingEraRewardPoints,
      number
    >;
    ...
    unappliedSlashes: GenericStorageQuery<
      Rv,
      (arg: number) => Array<PalletStakingUnappliedSlash>,
      number
    >;
  ...
  fellowshipCollective: {
     ...
     * @param {Callback<AccountId32 | undefined> =} callback
     **/
    indexToId: GenericStorageQuery<
      Rv,
      (arg: [number, number]) => AccountId32 | undefined,
      [number, number]
    >;
    ...
    voting: GenericStorageQuery<
      ...
      (
        arg: [number, AccountId32Like],
      ) => PalletRankedCollectiveVoteRecord | undefined,
      [number, AccountId32]
    >;
     ...
     **/
    votingCleanup: GenericStorageQuery<
      Rv,
  ...
  fellowshipReferenda: {
    ...
    referendumInfoFor: GenericStorageQuery<
      Rv,
      (arg: number) => PalletReferendaReferendumInfoTally | undefined,
      number
    >;
    ...
    trackQueue: GenericStorageQuery<
      Rv,
      (arg: number) => Array<[number, number]>,
      number
    >;
  ...
  electionProviderMultiPhase: {
     ...
     **/
    queuedSolution: GenericStorageQuery<
      Rv,
      () => PalletElectionProviderMultiPhaseReadySolution | undefined
    >;
     ...
     **/
    snapshot: GenericStorageQuery<
      Rv,
      () => PalletElectionProviderMultiPhaseRoundSnapshot | undefined
    >;
     ...
     **/
    snapshotMetadata: GenericStorageQuery<
      Rv,
      () => PalletElectionProviderMultiPhaseSolutionOrSnapshotSize | undefined
    >;
     ...
     **/
    signedSubmissionIndices: GenericStorageQuery<
      Rv,
      () => Array<[SpNposElectionsElectionScore, number, number]>
    >;
    ...
    signedSubmissionsMap: GenericStorageQuery<
      ...
      (
        arg: number,
      ) => PalletElectionProviderMultiPhaseSignedSignedSubmission | undefined,
      number
    >;
     ...
     **/
    minimumUntrustedScore: GenericStorageQuery<
      Rv,
  ...
  offences: {
    ...
    reports: GenericStorageQuery<
      Rv,
      (arg: H256) => SpStakingOffenceOffenceDetails | undefined,
      H256
    >;
  ...
  childBounties: {
     ...
     * @param {Callback<Bytes | undefined> =} callback
     **/
    childBountyDescriptions: GenericStorageQuery<
      Rv,
      (arg: number) => Bytes | undefined,
      number
    >;
  ...
  gearProgram: {
    ...
    codeStorage: GenericStorageQuery<
      Rv,
      (
        arg: GprimitivesCodeId,
      ) => GearCoreCodeInstrumentedInstrumentedCode | undefined,
      GprimitivesCodeId
    >;
     ...
     * @param {Callback<number | undefined> =} callback
     **/
    codeLenStorage: GenericStorageQuery<
      Rv,
      (arg: GprimitivesCodeId) => number | undefined,
      GprimitivesCodeId
    >;
     ...
     * @param {Callback<Bytes | undefined> =} callback
     **/
    originalCodeStorage: GenericStorageQuery<
      Rv,
      (arg: GprimitivesCodeId) => Bytes | undefined,
      GprimitivesCodeId
    >;
    ...
    memoryPages: GenericStorageQuery<
      ...
      ) => GearCoreMemoryPageBuf | undefined,
  ...
  gearMessenger: {
    ...
    dispatches: GenericStorageQuery<
      ...
      ) => GearCommonStorageComplicatedDequeueLinkedNode | undefined,
      GprimitivesMessageId
    >;
  ...
  gearScheduler: {
     ...
     * @param {Callback<number | undefined> =} callback
     **/
    firstIncompleteTasksBlock: GenericStorageQuery<
      Rv,
      () => number | undefined
    >;
  ...
  gearGas: {
    ...
    gasNodes: GenericStorageQuery<
      Rv,
      (
        arg: GearCommonGasProviderNodeGasNodeId,
      ) => GearCommonGasProviderNodeGasNode | undefined,
      GearCommonGasProviderNodeGasNodeId
    >;
  ...
  gearVoucher: {
    ...
    vouchers: GenericStorageQuery<
      Rv,
      (
        arg: [AccountId32Like, PalletGearVoucherInternalVoucherId],
      ) => PalletGearVoucherInternalVoucherInfo | undefined,
  ...
  gearBank: {
     ...
     **/
    bank: GenericStorageQuery<
      Rv,
      (arg: AccountId32Like) => PalletGearBankBankAccount | undefined,
      AccountId32
    >;
     ...
     * @param {Callback<bigint | undefined> =} callback
     **/
    onFinalizeTransfers: GenericStorageQuery<
      Rv,
